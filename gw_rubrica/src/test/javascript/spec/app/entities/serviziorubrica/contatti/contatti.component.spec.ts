...
import { ContattiComponent } from 'app/entities/serviziorubrica/contatti/contatti.component';
...
describe('Component Tests', () => {
  describe('Contatti Management Component', () => {
    let comp: ContattiComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContattiComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contattis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
